import {
  ...
  export default function Extrato() {
    ...
    const buscarDados = async (reset = false) => {
      try {
        ...
        const novosDados = reset
          ? dadosTransacoes
          : [...transacoes, ...dadosTransacoes.slice(pagina * itensPorPagina, (pagina + 1) * itensPorPagina)];
    ...
    const renderItem = ({ item }: any) => (
      <View style={styles.transacao}>
        ...
        <Text style={[styles.valor, { color: item.tipo === 'CREDITO' ? '#22c55e' : '#ef4444' }]}>
    ...
    return (
        ...
        <View style={styles.conteudo}>
          ...
          {loading ? (
            ...
            <FlatList
              data={transacoes.slice(0, pagina * itensPorPagina)}
